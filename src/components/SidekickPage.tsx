  ...
  return (
    <Box className={styles.root}>
      <ProductContextBanner
        tone="sidekick"
        title={<>Meet Sidekick &ndash; your AI assistant</>}
        description={
          <>
            From now on, you&apos;ve got Sidekick by your side.
            <br />
            Ask it to set things up, answer questions, or take action - it
      ...
      <div className={styles.heroBlock}>
        ...
        <div
          ...
          data-tour-target="sidekick-composer"
        >
            ...
            >
              <Flex align="center" gap="xs">
                ...
                <button
                  ...
                  data-tour-target="sidekick-context"
                >
                  @ Add context
                </button>
              </Flex>
